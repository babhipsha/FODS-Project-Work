"""
analytics.py  (Bonus feature - Borrowing Analytics, 10 marks)
Generates:
    1. A bar chart of borrowing frequency per genre ("Most Popular Genres")
    2. A bar chart of borrowing trend over time (loans per month)
    3. Alerts for members with a high frequency of overdue books
Requires matplotlib.
"""
