"""
exceptions.py
Custom exception hierarchy used across the Library Resource Management System.
Keeping these in one place makes error handling consistent and demonstrates
proper use of exception handling as required by the assessment brief.
"""
