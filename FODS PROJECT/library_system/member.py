"""
member.py
Defines the User base class and its Librarian / Student subclasses.
This demonstrates OOP + inheritance as required by the assessment brief:
role-specific behaviour is implemented via method overriding (menu()) and
extra attributes/permissions on each subclass.
"""
